...
# ssh
 export SSH_KEY_PATH="~/.ssh/bsd_rsa"
...
[ -f ~/.dotfiles/startx.rc ] && source ~/.dotfiles/startx.rc


# https://makandracards.com/makandra/29393-start-terminator-with-split-screens-and-custom-commands-running
# hack to keep a bash open when starting it with a command
[[ $startup_cmd_zsh ]] && { declare +x $startup_cmd_zsh; eval "$startup_cmd_zsh"; }
#
